        ...
        <Container>
          <div className="bg-primary text-primary-foreground rounded-lg px-6 py-10 md:flex md:items-end md:justify-between md:px-10 md:py-12">
            ...
            <div className="mt-6 md:mt-0">
              <Link
                href="/contact"
                className="bg-background text-foreground hover:bg-background/90 inline-flex h-11 items-center justify-center rounded-sm px-6 text-sm font-semibold transition-colors"
              >
