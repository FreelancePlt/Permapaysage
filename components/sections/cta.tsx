    ...
    <section className="relative overflow-hidden bg-primary py-20 md:py-28">
      ...
      <Container>
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <Link
            href={ctaHref}
            className="mt-8 inline-flex h-14 items-center justify-center gap-2 rounded-xl bg-white px-10 text-base font-bold text-primary shadow-lg transition-all hover:bg-white/90 hover:shadow-xl hover:scale-[1.02]"
          >
            {ctaText}
